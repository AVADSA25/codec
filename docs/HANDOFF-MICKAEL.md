...
| B — Projects (+ Pilot) | 7 | ✅ Audit done (20 findings). **Wave 7: ALL CRITICAL/HIGH closed — B-1…B-9 ✅ (PR-7A…7I). MEDIUM/LOW: B-10+B-11 ✅ (PR-7J); B-12…B-20 remain.** **Pilot half deferred** — needs the `~/codec/pilot/` checkout. |
