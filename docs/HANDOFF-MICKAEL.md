...
| F — Investor readiness | 6 | 🟢 ~92% closed — F-1,2,3,5,6,7,9,10,13,14,16,17 done; F-18 partial. Remaining gated on you: F-4 (ruff-cleanup decision), F-8 (GIF), F-11 (pricing), F-12 (Discord), F-15 (pyproject, deferred). |
