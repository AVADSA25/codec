...
| B — Projects (+ Pilot) | 7 | ✅ Audit done (20 findings). **Wave 7: ALL CRITICAL/HIGH closed — B-1…B-9 ✅ (PR-7A…7I). MEDIUM/LOW: B-10+B-11 ✅ (7J), B-13+B-19 ✅ (7K), B-15+B-18 ✅ (7L), B-20 ✅ (7M), B-12+B-14 ✅ (7N); B-16/B-17 remain (→ PR-7O).** **Pilot half deferred** — needs the `~/codec/pilot/` checkout. |
