...
| B — Projects (+ Pilot) | 7 | ✅ Audit done (20 findings). **Wave 7: B-1/B-2/B-3/B-4/B-6/B-7/B-8/B-9 ✅ (PR-7A…7H). Only B-5 (resume history) + MEDIUM/LOW (B-10…B-20) remain.** **Pilot half deferred** — needs the `~/codec/pilot/` checkout. |
